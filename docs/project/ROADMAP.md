...
## Phase 1 — Desktop MVP ✅
- [x] Tauri v2 transparent frameless window
- [x] 3D star rendering with PBR materials
- [x] Window dragging + controls
- [x] Click-through mode with escape hatches
- [x] Immersive mode
- [x] Theme system
...
- [ ] Snow particle effects (Christmas mode)
